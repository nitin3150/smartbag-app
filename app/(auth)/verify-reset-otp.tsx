...
//             <Text className="text-2xl font-bold mb-6">Verify Code</Text>
            ...
            <View className="flex-1 px-6 justify-center">
                ...
                <View className="bg-blue-50 rounded-xl p-4 mb-6">
                    <View className="flex-row items-start mb-2">
                        ...
                        <Text className="text-blue-900 font-semibold ml-2 flex-1">
                            Check your spam folder
                        </Text>
                    </View>
                    <Text className="text-blue-700 text-sm ml-7">
