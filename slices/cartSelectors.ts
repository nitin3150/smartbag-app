...
// // New selectors for services
// export const selectProductItems = createSelector(
//     [selectCartItems],
//     (items) => items.filter(item => item.serviceType === 'product')
// );
...
//     [selectCartItems],
//     (items) => items.filter(item => item.serviceType === 'porter')
// );

// export const selectPrintoutServices = createSelector(
//     [selectCartItems],
//     (items) => items.filter(item => item.serviceType === 'printout')
// );
